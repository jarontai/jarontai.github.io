...
categories: 翻译 Dart
---
  译者注：本文欢迎转载，请添加本文链接并标明出处。本文翻译的是Google Dart项目组撰写的《Dart：Up and Running》的第一章。部分新近出现的、暂无标准翻译的技术向词语，都用星号做了标注，在文章尾部的附注可以查看它们的原文。水平有限，本文仅作参考。
___
<br/>
...
{% endcodeblock %}
  ...
  你将在第二章及第三章，更详细的学习Dart语言及它的标准库。（译者注：这里是指《Dart：Up and Running》的第二、第三章）
