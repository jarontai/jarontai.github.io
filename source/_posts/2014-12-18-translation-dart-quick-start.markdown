...
### 为什么Google要创造Dart
  ...
  虽然web平台有着上述非常多的改进，但开发者的体验却没有随之而改善。我们认为，在当前的web平台下，构建大型、复杂的web应用，还是比较麻烦的。趁手的web开发工具来的太慢，并且还远落后于其他开发平台。你需要熟知web开发的方方面面，才能为现代web开发应用。另外，虽然JavaScript引擎变得越来越快，但web应用的启动还是很慢。
