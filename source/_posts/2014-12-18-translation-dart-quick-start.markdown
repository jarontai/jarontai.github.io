...
___
<br/>
  欢迎你来学习Dart！Dart是一个开源、开箱即用的（*1）的，专注于构建HTML5 web应用的开发平台。本文将告诉你Google为什么要创造Dart，Dart具有哪些酷炫的特性，以及如何编写、运行你的第一个Dart应用。
...
### Dart的酷炫特性
  ...
  Dart简单易学，大部分的开发者都可以快速学习它。它不仅有着熟悉的语法，还是一门拥有类、单继承、词法作用域、顶层函数等诸多特性的面向对象语言。许多开发者在数小时内就可以上手。
